...
require (
	...
	github.com/SigNoz/signoz-otel-collector v0.79.14
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite v0.88.0
